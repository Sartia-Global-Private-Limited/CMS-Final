                    ...
                    <Card.Body>
                        <div className="d-align flex-column text-center">
                            ...
                            <div className="d-align my-bg p-2 rounded-circle">
                                <img className="rounded-circle" height={120} width={120} src="assets/images/default-image.png" alt="User-Profile" />
                            </div>
            ...
            <Col md={12}>
                <CardComponent title={'Login Credentials'}>
                    <Row>
                        ...
                        <Form.Group as={Col}>
                            <Form.Control as="textarea" rows={6} disabled defaultValue='Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.' />
                        </Form.Group>
                    </Row>
                </CardComponent>
            </Col>
