...
const ApprovedComplaint = ({ data }) => {
  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor("status_changed_on", {
        header: t("Approved On"),
        cell: (info) =>
          moment(info.row.original.status_changed_on).format("YYYY-MM-DD"),
      }),
      columnHelper.accessor("status_changed_by_name", {
        header: t("Approved By"),
      }),
      columnHelper.accessor("approved", {
        header: t("Status"),
        cell: (info) => <span className="text-orange">Approved</span>,
      }),
