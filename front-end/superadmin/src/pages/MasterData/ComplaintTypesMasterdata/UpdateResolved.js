...
import { updateAssignComplaintToUser } from "../../../services/authapi";
...
const UpdateResolved = () => {
  ...
  const handleSubmit = async (values, { setSubmitting, resetForm }) => {
    ...
    const res = edit?.isComplaintAssigned
      ? await updateAssignComplaintToUser(values)
      : await postAssignComplaintToUser(values);
