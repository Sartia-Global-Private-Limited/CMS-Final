...
const AddPurchaseCompanies = () => {
  ...
  const handleSubmit = async (values, { setSubmitting, resetForm }) => {
    ...
    const res = edit?.company_id
      ? await updateAdminPurchaseCompanies(values)
  ...
  return (
    <Col md={12} data-aos={"fade-up"}>
      <CardComponent
        title={`${edit.company_id ? "Update" : "Add"} Vendor Company`}
      >
        <Formik
          ...
          initialValues={{
            ...
            enable_company_type: edit.enable_company_type || "0",
            email: edit.email ? edit.email : edit.primary_contact_email || "",
            password: "",
            state: edit.state || "",
            city: edit.city || "",
            pin_code: edit.pin_code || "",
            company_type: edit.company_type || "2",
              ...
              <Row className="g-3 align-items-center">
                ...
                <Form.Group as={Col} md={4}>
                  <MyInput
                    ...
                    selectProps={{
                      data: allState,
                      onChange: (e) => fetchCityData(e?.value),
                    }}
                  />
                </Form.Group>
                <Form.Group as={Col} md={4}>
