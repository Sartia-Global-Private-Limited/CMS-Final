...
const AllReadyToPi = () => {
  ...
  const columns = useMemo(() => {
    ...
    return baseColumns;
  }, [poId?.id && regionalOfficceId?.id, pageNo, pageSize]);
                      ...
                      <tbody>
                        ...
                        {allComplaints.map((data, id1) => (
                          <tr key={id1}>
                            ...
                            <td>{data?.company_details?.name ?? "--"}</td>
                            <td>{data?.area_manager_name ?? "--"}</td>
                                      ...
                                      onClick={() => {
                                        navigate(
                                          `/PerformaInvoice/CreatePerformaInvoice/new`,
                                          {
                                            state: {
                                              regionalOfficceId: {
                                                name: data?.po_regional_office_name,
                                                id: data?.po_ro_id,
                                              },
                                              ...
                                              companyDetails: {
                                                name: data?.po_company_name,
                                                id: data?.po_company_id,
                                                complaint_for:
                                                  data?.complaint_for,
                                              },
                                            },
