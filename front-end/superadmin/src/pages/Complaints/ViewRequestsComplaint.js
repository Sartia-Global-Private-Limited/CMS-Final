...
const ViewRequestsComplaint = () => {
  ...
  // let checkPermission = location?.state?.checkPermission;
  let checkPermission = 1;
                    ...
                    <tr>
                      ...
                      <td>
                        {dataById?.regionalOffices?.map((ro, id3) => {
                          return ro.regional_office_name;
                        })}
                      </td>
                    </tr>
                  )}
                        ...
                        <ActionButtons
                          ...
                          actions={{
                            edit: {
                              ...
                              action: () =>
                                navigate(`/create-complaint/${dataById?.id}`),
                            },
                            approve: {
                              show:
                                type || dataById?.status === "working"
                                  ? false
                                  : checkPermission
                                  ? true
                                  : false,
                              disabled: !dataById.hasComplaintApprovedAccess,
                              action: () => handleCheckboxChange(dataById, 1),
                            },
                            reject: {
                              show:
                                type || dataById?.status === "working"
                                  ...
                                  : false,
                              disabled: !dataById.hasComplaintApprovedAccess,
                              action: () => handleCheckboxChange(dataById, 4),
                            },
                          }}
                        />
                      </td>
