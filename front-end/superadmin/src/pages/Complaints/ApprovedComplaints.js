...
import { BsFillPersonCheckFill, BsPencil, BsSearch } from "react-icons/bs";
...
const ApprovedComplaints = ({ checkPermission }) => {
  ...
  const tabs = [
    {
      title: t("Un-Assign"),
      className: "ms-auto",
      page: <TableComponent checkPermission={checkPermission} />,
    },
    {
      title: t("Assign"),
      page: <TableComponent checkPermission={checkPermission} />,
  ...
  function TableComponent({ checkPermission }) {
    return (
      <>
        <CustomTable
