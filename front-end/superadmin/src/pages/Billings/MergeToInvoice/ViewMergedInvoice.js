...
import {
  getDetailsOfMergedInvoice,
  getInvoiceDetails,
} from "../../../services/contractorApi";
import { useTranslation } from "react-i18next";

const ViewMergedInvoice = () => {
  ...
  return (
    <CardComponent showBackButton={true} title={"View merged Invoice"}>
        ...
        return (
          <>
            <div className="d-flex justify-content-center fw-bold my-2 purple-combo fs-6	">
              {t("Bill Number")}- {Invoice.invoice_no}
            </div>
...
export default ViewMergedInvoice;
