...
const Payments = () => {
  ...
  return (
    <Col md={12}>
      <CardComponent title={'Payments'} icon={<BsPlus />} link={'/CreateNewPayments'} tag={'Create'}>
        <div className='overflow-auto p-2'>
          <Table className='text-body bg-new Roles'>
            <thead className='text-truncate'>
              <tr>
                {['Invoice', 'Payment Date', 'Payment Voucher', 'Payment Amount', 'Retention Date', 'Retention Amount', 'Action'].map((thead) => (
                  ...
                  <td>
                    <span className='d-align gap-2'>
                      ...
                      <TooltipComponent title={t('Edit')}>
                        <Link to='/CreateNewPayments'><BsPencilSquare className='social-btn danger-combo' /></Link>
                      </TooltipComponent>
                    </span>
                  </td>
                </tr>
