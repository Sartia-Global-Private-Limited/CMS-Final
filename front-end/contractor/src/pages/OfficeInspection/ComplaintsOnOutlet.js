...
const ComplaintsOnOutlet = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          {`All Complaints On - ${outletDetails?.outlet_name} · CMS Electricals`}
        </title>
      </Helmet>
      <Col md={12} data-aos={"fade-up"}>
        <CardComponent
          title={`All Complaints On - ${outletDetails?.outlet_name}`}
          search={true}
          searchOnChange={(e) => {
                      ...
                      <tr>
                        ...
                        <td>
                          <ActionButton
                            hideDelete={"d-none"}
                            hideEdit={"d-none"}
                            eyelink={`/stock-management/pending-complaints/${e.complaint_unique_id}?prevId=${id}&&type=${type}`}
                          />
                        </td>
                      </tr>
                    ))}
...
export default ComplaintsOnOutlet;
