...
import StockBalanceOverview from "./StockBalanceOverview";
import ViewStockTransactions from "./ViewStockTransactions";

const TABS = [
  { component: StockRequest, eventKey: "0" },
  { component: StockTransfer, eventKey: "1" },
  { component: StockBalanceOverview, eventKey: "2" },
  { component: ViewStockTransactions, eventKey: "3" },
];
