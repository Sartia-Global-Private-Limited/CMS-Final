...
import { getAllPOTransactions } from "../../../services/contractorApi";
...
const POTransactions = ({ checkPermission }) => {
          ...
          <ActionButtons
            actions={{
              view: {
                ...
                action: () =>
                  navigate(
                    `/regional-office/view-po-details/${info.row.original.ro_id}`
                  ),
              },
            }}
          />
  ...
  return (
    <CustomTable
      ...
      excelAction={false}
      pdfAction={false}
      apiForExcelPdf={getAllPOTransactions}
