...
import { getAllRegionalOfficeTransactionById } from "../../../services/contractorApi";
    ...
    <Col md={12}>
      ...
      >
                ...
                <table className="table-sm table">
                  <tbody>
                    <tr>
                      ...
                      <td>{rows?.getBalance?.regional_office_name}</td>
                    </tr>
                    <tr>
                      <th>{t("po number")} :</th>
        ...
        <CustomTable
          ...
          excelAction={false}
          pdfAction={false}
          apiForExcelPdf={getAllRegionalOfficeTransactionById}
