...
const TABS = [
  { component: AllRegionalOffice, eventKey: "0" },
  { component: ROTransactions, eventKey: "1" },
  { component: POTransactions, eventKey: "2" },
];
...
const RegionalOffice = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Regional Office Management · {HEADER_TITLE_DEFAULT}</title>
      </Helmet>
