...
import ViewStockTransaction from "./ViewStockTransaction";
import StockPunchRequest from "./StockPunchRequest";
import StockPunch from "./StockPunch";
import StockPunchBalanceOverview from "./StockPunchBalanceOverview";
import AllStockTransferPunch from "./AllStockTransferPunch";

const TABS = [
  { component: StockPunchRequest, eventKey: "0" },
  { component: StockPunch, eventKey: "1" },
  { component: AllStockTransferPunch, eventKey: "2" },
  { component: StockPunchBalanceOverview, eventKey: "3" },
  { component: ViewStockTransaction, eventKey: "4" },
];

const VieStockPunchManagement = () => {
...
export default VieStockPunchManagement;
