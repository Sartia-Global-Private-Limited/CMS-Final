...
import PendingExpense from "./OfficeInspectionStock/PendingExpense";
import PendingFund from "./OfficeInspectionFund/PendingFund";

const TABS = [
  { component: PendingExpense, eventKey: "0" },
  { component: PendingFund, eventKey: "1" },
];

const ViewOfficeInspection = () => {
...
export default ViewOfficeInspection;
