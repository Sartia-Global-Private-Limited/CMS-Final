...
export default function RetentionProcess({ checkPermission }) {
  ...
  const columns = useMemo(() => {
          ...
          <ActionButtons
            actions={{
              ...
              reject: {
                ...
                action: () => {
                  setShowDiscard(info.row.original.id);
                },
              },
            }}
            custom={
    ...
    if (allComplaints.length > 0 && po_number) {
    ...
    checkPermission,
    allComplaints.length > 0 && po_number,
    pageNo,
    pageSize,
  ]);
    ...
    <>
      <div className="p-3">
        ...
        <CustomTable
          ...
          tableTitleComponent={
            <div>
              <UserPlus /> <strong> retention process</strong>
            </div>
          }
        />
