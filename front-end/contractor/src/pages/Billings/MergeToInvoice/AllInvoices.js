...
const AllInvoices = ({ checkPermission }) => {
  ...
  return (
    <>
      ...
      <Col md={12} data-aos={"fade-up"}>
        ...
        >
          <Tab className="pe-none fs-15 fw-bold " title={t("Merge Invoice")} />
          ...
          <Tab title={t("final")}>
            {activeTab == "3" && (
              <AllMegeInvoices checkPermission={checkPermission} />
            )}
          </Tab>
          <Tab title={t("discard")}>
            {activeTab == "4" && (
              <DiscardMergeInvoices checkPermission={checkPermission} />
            )}
          </Tab>
        </Tabs>
      </Col>
