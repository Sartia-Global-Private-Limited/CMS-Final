...
const AllFinalPI = ({ checkPermission }) => {
  ...
  const columns = useMemo(() => {
    ...
    checkPermission,
    regionalOfficceId.id && billingFromId && billingToId,
    pageNo,
    pageSize,
  ]);
      ...
      <Col md={12} data-aos={"fade-up"}>
        ...
        >
          ...
          <Tab title={t("final invoice")}>
            {activeTab == "3" && (
              <AllFinalInvoices checkPermission={checkPermission} />
            )}
          </Tab>
          <Tab title={t("discard")}>
            {activeTab == "4" && (
              <DiscardInvoices checkPermission={checkPermission} />
            )}
          </Tab>
        </Tabs>
      </Col>
