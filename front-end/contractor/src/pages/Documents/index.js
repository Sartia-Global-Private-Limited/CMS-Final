...
const TABS = [
  { component: DocumentCategory, eventKey: "0" },
  // { component: AddDocument, eventKey: "1" },
  { component: DocumentsList, eventKey: "1" },
];
...
const Documents = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Documents Management · {HEADER_TITLE_DEFAULT}</title>
      </Helmet>
