...
const ViewGroupInsurance = () => {
  ...
  const singleoutletsList = [
    ...
    },
    {
      id: 7,
      col: 6,
      title: t("Policy Coverage Limits"),
    ...
    },
    {
      id: 9,
      col: 6,
      title: t("Policy Deductible Amount"),
          ...
          <Col md={6}>
            <Row className="g-3">
              <Form.Group as={Col} md={12}>
                <div className="d-align justify-content-start gap-4">
                  <Form.Check
                    ...
                    checked={Boolean(edit?.insurance_for == "Employee Wise")}
                  />
                  ...
                  <Form.Check
                    ...
                    checked={Boolean(edit?.insurance_for == "Designation Wise")}
                  />
              ...
              <Form.Group as={Col} md={6}>
                <Form.Label>{t("Select Insurance Company")}</Form.Label>
                <div className="bg-primary-light form-shadow text-gray small fw-bold px-2 py-1">
                  {edit?.insurance_company_name
                    ? edit?.insurance_company_name
                    : "--"}
                </div>
              </Form.Group>
              <Form.Group as={Col} md={6}>
                <Form.Label>{t("Select Plans")}</Form.Label>
                <div className="bg-primary-light form-shadow text-gray small fw-bold px-2 py-1">
                  {edit?.insurance_plan_name ? edit?.insurance_plan_name : "--"}
                </div>
              </Form.Group>
              <Form.Group as={Col} md={12}>
                <Form.Label>{t("insurance deduction amount")}</Form.Label>
                <Form.Control
                  disabled
