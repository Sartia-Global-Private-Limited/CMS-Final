...
const AllocateEarthingTesting = ({ checkPermission }) => {
  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor("status", {
        header: t("status"),
        cell: (info) => <StatusChip status={"Allocate"} />,
      }),
    ...
    <>
      <Col md={12}>
        <CustomTable
          ...
          tableTitleComponent={
            <div>
              <FileText /> <strong>Allocate Earthing Testing</strong>
            </div>
          }
        />
      </Col>
...
export default AllocateEarthingTesting;
