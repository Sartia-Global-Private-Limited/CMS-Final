...
import { deletePurchaseOrderById } from "../../services/contractorApi";
...
import ApprovedFundItem from "./ApprovedFundItem";
import RejectedFundtem from "./RejectedFundtem";
import AllFundItem from "./AllFundItem";
...
const FundItem = ({ checkPermission }) => {
          ...
          <ActionButtons
            actions={{
              ...
              edit: {
                ...
                action: () =>
                  navigate(
                    `/fund-request/create-fund-request/${info.row.original.fund_stock_id}?type=edit`
                  ),
              },
              delete: {
  ...
  return (
    <>
      ...
      >
        <Tab className="pe-none fs-15 fw-bold" title={t("Fund Item Request")} />
        ...
        <Tab title={t("Approved")}>
          {activeTab == "3" && (
            <ApprovedFundItem checkPermission={checkPermission} />
          )}
        </Tab>

        <Tab title={t("Rejected")}>
          {activeTab == "4" && (
            <RejectedFundtem checkPermission={checkPermission} />
          )}
        </Tab>

        <Tab title={t("Fund Item")}>
          {activeTab == "5" && (
            <AllFundItem checkPermission={checkPermission} />
          )}
        </Tab>
      </Tabs>
    </>
