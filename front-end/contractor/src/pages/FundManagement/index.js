...
import FundTransfer from "./fund-transfer/FundTransfer";
import FundBalanceOverview from "./FundRequest/FundBalanceOverview";
import ViewFundTransactions from "./ViewFundTransactions";

const TABS = [
  { component: FundRequest, eventKey: "0" },
  { component: FundTransfer, eventKey: "1" },
  { component: FundBalanceOverview, eventKey: "2" },
  { component: ViewFundTransactions, eventKey: "3" },
];
