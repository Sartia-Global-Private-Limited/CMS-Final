    ...
    return (
        <Row className='g-4'>
            ...
            <Col md={8} data-aos={"fade-up"} data-aos-delay={100}>
                ...
                <TextareaAutosize minRows={4} className='edit-textarea' defaultValue='Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.' />
            </Col>
        </Row>
    )
}
