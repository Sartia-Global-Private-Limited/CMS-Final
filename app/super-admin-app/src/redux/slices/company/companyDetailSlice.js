  ...
  async company_id => {
    try {
      const {data} = await customApi.get(
        `/api/super-admin/company/my-company/get-my-company-single-details/${company_id}`,
      );
...
export const getClientCompanyDetailById = createAsyncThunk(
  ...
  async company_id => {
    try {
      const {data} = await customApi.get(
        `/api/super-admin/company/client/get-sale-company/${company_id}`,
      );
...
export const getVendorCompanyDetailById = createAsyncThunk(
  ...
  async company_id => {
    try {
      const {data} = await customApi.get(
        `/api/super-admin/company/vendor/get-purchase-company/${company_id}`,
      );
