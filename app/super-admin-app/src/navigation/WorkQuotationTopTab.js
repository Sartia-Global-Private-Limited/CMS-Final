...
const WorkQuotationTopTab = () => {
  const label = ScreensLabel();
  return (
    <>
      <View style={{marginBottom: 1}}>
        <CustomeHeader headerTitle={label.WORK_QUOTATION} />
      </View>
      <Tab.Navigator
        initialRouteName={{WorkQuotationListScreen}}
        sceneContainerStyle={{
...
export default WorkQuotationTopTab;
