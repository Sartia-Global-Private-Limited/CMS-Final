...
import {createAllowance} from '../../../redux/slices/hr-management/payroll-master/addUpdateAllowanceSlice';
    ...
    <SafeAreaView
      ...
      <ScrollView>
        <View style={styles.inpuntContainer}>
          {formik?.values?.allowance.map((item, index) => (
            <ListItem.Accordion
              containerStyle={{
              ...
              <View
                ...
                <CheckBox
                  ...
                  checked={formik?.values?.allowance[index].applied_type === 1}
                  onPress={() => {
                    formik.setFieldValue(`allowance.${index}.applied_type`, 1);
                    formik.setFieldValue(`allowance.${index}.applied_on`, '');
                  }}
                ...
                <CheckBox
                  ...
                  checked={formik?.values?.allowance[index].applied_type === 2}
                  onPress={() => {
                    formik.setFieldValue(`allowance.${index}.applied_type`, 2);
                    formik.setFieldValue(`allowance.${index}.applied_on`, '');
                  }}
                  checkedColor={Colors().aprroved}
                />
              ...
              <View style={[styles.twoItemView, {marginTop: 10}]}>
                <View style={styles.leftView}>
                  <NeumorphicDropDownList
                    ...
                    data={allowanceType}
                    value={formik?.values?.allowance[index].value_type}
                    onChange={val => {
                      formik.setFieldValue(
                ...
                <View style={styles.rightView}>
                  <NeumorphicTextInput
                    ...
                    title={'value'}
                    value={formik?.values?.allowance[index].value}
              ...
              {index == 7 && (
                <View style={{rowGap: 8, marginTop: 10}}>
                  <NeumorphicTextInput
                    ...
                    value={formik?.values?.allowance[index].name}
                    // keyboardType="number-pad"
                    onChangeText={formik.handleChange(
                      `allowance.${index}.name`,
                    )}
                  />
                </View>
              )}
