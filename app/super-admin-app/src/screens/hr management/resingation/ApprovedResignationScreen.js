...
import {getApprovedResignationList} from '../../../redux/slices/hr-management/resignation/getApprovedResignationSlice';
import RNFetchBlob from 'rn-fetch-blob';
import List from '../../../component/List/List';
import CustomeCard from '../../../component/CustomeCard';
const ApprovedResignationScreen = ({navigation, route}) => {
  /* declare props constant variale*/

  /*declare hooks variable here */
  const dispatch = useDispatch();
  const isFocused = useIsFocused();
  const approvedResignatioData = useSelector(
    state => state.getApprovedResignation,
  );
  ...
  useEffect(() => {
    dispatch(getApprovedResignationList());
  }, [isFocused]);
          ...
          <CustomeCard
            ...
            data={[
              ...
              },
              {
                ...
                value:
                  `${moment(item?.last_working_day).format(
                    'DD/MM/YYYY dddd',
                  )}` ?? '--',
              },
            ]}
  ...
  const handlePageClick = () => {
    dispatch(getApprovedResignationList({pageSize: pageSize, pageNo: pageNo}));
  };
...
export default ApprovedResignationScreen;
