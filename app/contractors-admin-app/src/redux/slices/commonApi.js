...
export const getAllMyCompanyList = createAsyncThunk(
  ...
  async () => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-my-company-list`,
      );
...
export const getAllSalesCompanyList = createAsyncThunk(
  ...
  async ({ isDropdown = false }) => {
    try {
      const { data } = await customApi.get(
        `api/contractor/company/client/all-sale-companies?isDropdown=${isDropdown}`,
      );
...
export const getAllBillingType = createAsyncThunk(
  ...
  async () => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-all-billing-types?search=&&pageSize=&&pageNo=`,
      );
...
export const getOutletBySaId = createAsyncThunk(
  ...
  async saId => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-outlet-by-sale-area/${saId}`,
      );
...
export const getAllAccount = createAsyncThunk(
  ...
  async bank_id => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-bank-to-account/${bank_id}`,
      );
...
export const getFundItemListByUserId = createAsyncThunk(
  ...
  async id => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-user-fund-items-lists/${id}`,
      );
...
export const getApproveItemPriceByUserId = createAsyncThunk(
  ...
  async ({ itemId, userId }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-approve-item-price/${itemId}/${userId}`,
      );
...
export const getStockItemListByUserId = createAsyncThunk(
  ...
  async id => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-user-stock-items-lists/${id}`,
      );
...
export const getApproveStockItemPriceByUserId = createAsyncThunk(
  ...
  async ({ itemId, userId }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/stock-punch-get-approve-item-price/${itemId}/${userId}`,
      );
...
export const getPreviousBalance = createAsyncThunk(
  ...
  async userId => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-fund-request-details-by-request-for/${userId}`,
      );
...
export const getPreviousBalanceForStock = createAsyncThunk(
  ...
  async userId => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-stock-request-details-by-request-for/${userId}`,
      );
...
export const getAllOutletWithStatus = createAsyncThunk(
  ...
  async statusCode => {
    try {
      const { data } = await customApi.get(
        `api/contractor/get-all-outlet-by-id-new?status=${statusCode || ''}`,
      );
...
export const getSalesRAOnRoId = createAsyncThunk(
  ...
  async roId => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-all-sales-area-on-ro-id/${roId}`,
      );
...
export const getAllDistrictBySaId = createAsyncThunk(
  ...
  async saId => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-all-district-on-sale-area-id/${saId}`,
      );
...
export const getAllEmployeeListByRoleId = createAsyncThunk(
  ...
  async roleId => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-all-users/${roleId || ''}`,
      );
...
export const getAllSalesAreaWithStatus = createAsyncThunk(
  ...
  async stausCode => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-all-sales-by-id-new?status=${stausCode || ''}`,
      );
...
export const getAllRegionalOfficeWithStatus = createAsyncThunk(
  ...
  async statusCode => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-all-regional-by-id-new?status=${statusCode || ''}`,
      );
...
export const getAllCompanyForPTM = createAsyncThunk(
  ...
  async statusCode => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-all-companies-in-ptm?status=${statusCode || ''}`,
      );
...
export const getAllCompanyForBilling = createAsyncThunk(
  ...
  async statusCode => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-all-companies-in-billing?status=${statusCode || ''}`,
      );
...
export const getAllRoOfficeStockInspection = createAsyncThunk(
  ...
  async ({ statusCode }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-office-regional-list?status=${statusCode || ''}`,
      );
...
export const getAllSaOfficeStockInspection = createAsyncThunk(
  ...
  async ({ statusCode }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-office-sales-area?status=${statusCode || ''}`,
      );
...
export const getAllOutletOfficeStockInspection = createAsyncThunk(
  ...
  async ({ statusCode }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-office-outlet?status=${statusCode || ''}`,
      );
...
export const getAllSaSiteStockInspection = createAsyncThunk(
  ...
  async ({ statusCode }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-office-sales-area?status=${
          statusCode || ''
        }&&siteFor=1`,
      );
...
export const getAllOutletSiteStockInspection = createAsyncThunk(
  ...
  async ({ statusCode }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-office-outlet?status=${
          statusCode || ''
        }&&siteFor=1`,
      );
...
export const getAllOrderByWithStatus = createAsyncThunk(
  ...
  async statusCode => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-all-order-by-id-new?status=${statusCode || ''}`,
      );
...
export const getAllPTMOutletWithStatus = createAsyncThunk(
  ...
  async statusCode => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-all-outlets-in-ptm?status=${statusCode || ''}`,
      );
...
export const getAllPTMRegionalOfficeWithStatus = createAsyncThunk(
  ...
  async statusCode => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-all-regionals-in-ptm?status=${statusCode || ''}`,
      );
...
export const getAllPTMSalesAreaWithStatus = createAsyncThunk(
  ...
  async statusCode => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-all-sale-in-ptm?status=${statusCode || ''}`,
      );
...
export const getAllPTMOrderByWithStatus = createAsyncThunk(
  ...
  async statusCode => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-all-order-by-in-ptm?status=${statusCode || ''}`,
      );
...
export const getAllBillingOutletWithStatus = createAsyncThunk(
  ...
  async statusCode => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-all-outlet-in-billing?status=${statusCode || ''}`,
      );
...
export const getAllBillingRegionalOfficeWithStatus = createAsyncThunk(
  ...
  async statusCode => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-all-regional-in-billing?status=${
          statusCode || ''
        }`,
      );
...
export const getAllBillingSalesAreaWithStatus = createAsyncThunk(
  ...
  async statusCode => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-all-sales-in-billing?status=${statusCode || ''}`,
      );
...
export const getAllBillingOrderByWithStatus = createAsyncThunk(
  ...
  async statusCode => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-all-order-by-for-measurements?status=${
          statusCode || ''
        }`,
      );
...
export const getAllMangerListForPromotional = createAsyncThunk(
  ...
  async () => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-all-manager-list-with-total-free-end-users?search=&&pageSize=&&pageNo=&&status=`,
      );
...
export const getAllSupervisorAssigned = createAsyncThunk(
  ...
  async id => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-supervisor-assign?id=${id}`,
      );
...
export const getAllEndUserAssigned = createAsyncThunk(
  ...
  async id => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-end-user-assign?id=${id}`,
      );
...
export const getItemMasterDropDown = createAsyncThunk(
  ...
  async ({ category = '' }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-all-item-master-for-dropdown?category=${category}`,
      );
...
export const getAllBrand = createAsyncThunk('getAllBrand ', async () => {
  try {
    const { data } = await customApi.get(
      `/api/contractor/item-master/get-all-brand-markdown`,
    );
...
export const getPlansForInsuranceCompanny = createAsyncThunk(
  ...
  async companyId => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-plans-of-insurance-company/${companyId}`,
      );
...
export const getCompliantDropDown = createAsyncThunk(
  ...
  async () => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/complaints/get-all-complaints-list-dropdown`,
      );
...
export const getAllManger = createAsyncThunk(
  ...
  async ({ team = '' }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-all-managers-users?team=${team}`,
      );
...
export const getAllSupplier = createAsyncThunk('getAllSupplier ', async () => {
  try {
    const { data } = await customApi.get(
      `/api/contractor/suppliers/get-suppliers?search=&&pageSize=&&pageNo=&&isDropdown=true&&status`,
    );
...
export const getAllPvNumberWithStatusCode = createAsyncThunk(
  ...
  async statusCode => {
    try {
      const { data } = await customApi.get(
        `api/contractor/listing-pv-number?status=${statusCode || ''}`,
      );
...
export const getAllSupervisorByMangaerId = createAsyncThunk(
  ...
  async ({ managerId }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-all-supervisor-by-manager-with-count-free-end-users/${managerId}?complaintId=`,
      );
...
export const getUserDetailByComplaintId = createAsyncThunk(
  ...
  async ({ complaintId }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-user-details-by-complaint-id/${complaintId}`,
      );
...
export const getAllUserListByTeamId = createAsyncThunk(
  ...
  async ({ teamId }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-users-list-to-add-in-team/${teamId}`,
      );
...
export const getManagerDetailByUserId = createAsyncThunk(
  ...
  async ({ userId }) => {
    try {
      const { data } = await customApi.get(
        `api/contractor/get-area-manager-of-user/${userId}`,
      );
...
export const getStockDetailByItemIdUserId = createAsyncThunk(
  ...
  async ({ itemId, userId }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-stock-details-on-item-id/${itemId}/${
          userId ? userId : 0
        }`,
      );
...
export const getFundRequestDetailByItemId = createAsyncThunk(
  ...
  async ({ itemId }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-fund-request-details-on-item-id/${itemId}`,
      );
...
export const getStockRequestDetailByItemId = createAsyncThunk(
  ...
  async ({ itemId, userId }) => {
    try {
      const { data } = await customApi.get(
        `api/contractor/get-stock-details-on-item-id/${itemId}/${userId}`,
      );
...
export const getAllEmplist = createAsyncThunk('getAllEmplist ', async () => {
  try {
    const { data } = await customApi.get(
      `/api/contractor/get-all-employees?search=&&pageSize=&&pageNo=&&isDropdown=false`,
    );
...
export const getLeaveTypelist = createAsyncThunk(
  ...
  async () => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-all-leave-type?search=&&pageSize=&&pageNo=`,
      );
...
export const getMonthlyComplaintCountByFY = createAsyncThunk(
  ...
  async financial_year => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-monthly-complaints?year_name=${
          financial_year || ''
        }`,
      );
...
export const getAreaManagerComplaints = createAsyncThunk(
  ...
  async selectedFY => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-area-managers?year_name=${selectedFY || ''}`,
      );
...
export const getEndUserComplaints = createAsyncThunk(
  ...
  async selectedFY => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-end-users-dashboard?year_name=${selectedFY || ''}`,
      );
...
export const getAreaManagerBillingDetails = createAsyncThunk(
  ...
  async selectedFY => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-area-manager-billing-dashboard?financial_year=${selectedFY || ''}`,
      );
...
export const getRoBillingDetails = createAsyncThunk(
  ...
  async selectedFY => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-ro-billing-dashboard?financial_year=${selectedFY || ''}`,
      );
...
export const getAllComplaintDataByFY = createAsyncThunk(
  ...
  async financial_year => {
    try {
      const { data } = await customApi.get(
        `api/contractor/get-total-complaints?year_name=${financial_year || ''}`,
      );
...
export const getAllComplaintData = createAsyncThunk(
  ...
  async ({ financial_year = '', status = '' }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/complaints/get-all-complaints?year_name=${financial_year}&status=${status}`,
      );
