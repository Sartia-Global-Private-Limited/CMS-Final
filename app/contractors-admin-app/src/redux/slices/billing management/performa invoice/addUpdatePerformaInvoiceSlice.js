  ...
  async statusCode => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/billing/performa-invoice/get-all-po-filters?status=${statusCode}`,
      );
...
export const getAllRoForReadyToPi = createAsyncThunk(
  ...
  async ({ statusCode, poId }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/billing/performa-invoice/get-all-ro-filters?status=${statusCode}&&po_id=${poId}`,
      );
      return data;
    } catch (error) {
      return {
...
export const getAllCompanyForReadyToPi = createAsyncThunk(
  ...
  async ({ statusCode, poId, roId }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/complaints/get-all-complaints-in-pi?status=${statusCode}&&ro_id=${roId}&&po_id=${poId}`,
      );
      return data;
    } catch (error) {
      return {
...
export const getAllPoForPi = createAsyncThunk(
  ...
  async statusCode => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/billing/performa-invoice/get-all-po-from-proforma?status=${statusCode}&&invoice=`,
      );
      return data;
    } catch (error) {
      return {
...
export const getAllRoForPi = createAsyncThunk(
  ...
  async ({ statusCode, poId }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/billing/performa-invoice/get-all-ro-from-proforma?status=${statusCode}&&po_id=${poId}&&invoice=`,
      );
      return data;
    } catch (error) {
      return {
...
export const getAllBillingNumberForPi = createAsyncThunk(
  ...
  async ({ statusCode, poId, roId }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/billing/performa-invoice/get-all-bill-number-from-proforma?status=${statusCode}&&ro_id=${roId}&&po_id=${poId}`,
      );
      return data;
    } catch (error) {
      return {
...
export const getAllOutletForPerforma = createAsyncThunk(
  ...
  async ({ statusCode, poId, roId, saId }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/billing/performa-invoice/get-all-outlet-filters?status=${statusCode}&&ro_id=${roId}&&po_id=${poId}&&sale_area_id=${saId}`,
      );
      return data;
    } catch (error) {
      return {
...
export const getAllSalesAreaforfilter = createAsyncThunk(
  ...
  async ({ statusCode }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/billing/performa-invoice/get-all-sales-area-from-proforma?status=${statusCode}`,
      );
      return data;
    } catch (error) {
      return {
...
export const getAllOrderByForBilling = createAsyncThunk(
  ...
  async ({ statusCode, piStatus }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-all-order-by-for-measurements?status=${statusCode}&pi_status=${piStatus}`,
      );
      return data;
    } catch (error) {
      return {
...
export const getAllAreaManager = createAsyncThunk(
  ...
  async ({
    ...
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-area-manager?status=${statusCode}&&po_id=${poId}&&ro_id=${roId}&&sale_area_id=${saId}&&outlet_id=${oId}&&company_id=${companyId}&&complaint_for=${complaintType}`,
      );
      return data;
    } catch (error) {
      return {
...
export const getAllComplaintTypeListInvoice = createAsyncThunk(
  ...
  async ({ statusCode }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-all-complaint-types-filters?status=${statusCode}`,
      );
      return data;
    } catch (error) {
      return {
...
export const getAllMeasurementItemListPi = createAsyncThunk(
  ...
  async ({ poId, measurementIds }) => {
    ...
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-measurements-detail-po?po_id=${poId}&&measurement_ids=${
          idsInStringFormat || ''
        }`,
        reqBody,
      );
...
export const getItemListofMeasurementItemPi = createAsyncThunk(
  ...
  async measurementId => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/get-items-on-measurement-id/${measurementId || ''}`,
      );
