...
export const getOilAndGasContacts = createAsyncThunk(
  ...
  async ({ search, pageSize, pageNo, id = '', user_id = '' }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/contacts/get-energy-company-users?id=${id}&&user_id=${user_id}&&search=${
          search || ''
        }&&pageSize=${pageSize || ''}&&pageNo=${pageNo || ''}`,
      );
...
export const getFuelStationContacts = createAsyncThunk(
  ...
  async ({ search, pageSize, pageNo }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/contacts/all-outlets?search=${
          search || ''
        }&&pageSize=${pageSize || ''}&&pageNo=${pageNo || ''}`,
      );
...
export const getDealerContact = createAsyncThunk(
  ...
  async ({ search, pageSize, pageNo }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/contacts/get-all-pending-account-status-of-dealers-and-users-details?search=${
          search || ''
        }&&pageSize=${pageSize || ''}&&pageNo=${pageNo || ''}`,
      );
...
export const getSupplierContact = createAsyncThunk(
  'getSupplierContact',
  async ({ search, pageSize, pageNo, status = '', isDropdown = '' }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/contacts/get-suppliers?search=${
          ...
          pageNo || ''
        }&&status=${status}&&isDropdown=${isDropdown}`,
      );
...
export const getClientContact = createAsyncThunk(
  ...
  async ({ search, pageSize, pageNo, type = '' }) => {
    try {
      const { data } = await customApi.get(
        `/api/contractor/contacts/get-client-users?search=${
          search || ''
  ...
  async requestbody => {
    try {
      const { data } = await customApi.post(
        `/api/contractor/contacts/contractors-and-users-set-account-status`,
        requestbody,
      );
      return data;
    } catch (error) {
