...
import { getAllowanceList } from '../../../redux/slices/hr-management/payroll/getAllowanceListSlice';
import List from '../../../component/List/List';
import CustomeCard from '../../../component/CustomeCard';

const AllowancesListScreen = ({}) => {
  /*declare hooks variable here */
  const dispatch = useDispatch();
  const isFocused = useIsFocused();
  const allowanceListData = useSelector(state => state.getAllowanceList);
  ...
  const handlePageClick = () => {
    dispatch(getAllowanceList({ pageSize: pageSize, pageNo: pageNo }));
  };
...
export default AllowancesListScreen;
