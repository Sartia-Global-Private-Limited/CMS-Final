    ...
    <SafeAreaView
      ...
      <ScrollView>
        <View style={styles.inpuntContainer}>
          ...
          {formik.touched.retirement_date && formik.errors.retirement_date && (
          ...
          {formik.touched.asset_recovery && formik.errors.asset_recovery && (
            <Text style={styles.errorMesage}>
          ...
          {formik.touched.pension_status && formik.errors.pension_status && (
            <Text style={styles.errorMesage}>
