...
import { getPaySlipList } from '../../../redux/slices/hr-management/payslip/getPaySlipListSlice';
import List from '../../../component/List/List';

const PaySlipListScreen = ({ navigation }) => {
  ...
  const geListData = useSelector(state => state.getPaySlipList);
  ...
  return (
    <SafeAreaView
      ...
      <CustomeHeader headerTitle={`PaySlip`} />
