...
const OfficeFundInspectionItemList = ({data, index, formik, type, purpose}) => {
                  ...
                  {type == 'approved' && (
                    <DataTable.Row
                      ...
                      <Text
                        ...
                        TOTAL Apporve Amount = ₹ {data?.total_office_amount}
                      </Text>
                    </DataTable.Row>
                  )}
                </ScrollView>
...
export default OfficeFundInspectionItemList;
