...
import { toggleDarkMode } from '../../redux/slices/darkmode/getDarkModeSlice';
import Colors from '../../constants/Colors';
import { toggleLanguage } from '../../redux/slices/languagelabel/getLanguageSlice';
          ...
          <ScrollView>
            <View style={styles.mainView}>
              ...
              <Text style={styles.addressTxt} numberOfLines={2}>
                Plan : {data?.plan_name} ( ₹ {data?.plan_price}/
                {data?.plan_duration})
              </Text>
              <Text style={styles.addressTxt} numberOfLines={2}>
                Plan Expire Date :{' '}
                {moment(data?.plan_expire_date).format('DD/MM/YYYY')}
              </Text>
                    ...
                    <View style={styles.tagTitleView}>
                      ...
                      <View style={{ padding: 5 }}>
                        <Icon
                          ...
                          color={Colors().pureBlack}
                          onPress={async () => {
                            await AsyncStorage.removeItem('cms-client-token');
                            dispatch(logout());
                            RNRestart.restart();
                          }}
                        />
