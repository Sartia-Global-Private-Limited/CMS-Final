...
const NewItemComponent = ({ item, index, formik, type, edit_id, edit }) => {
  ...
  const renderDropDown2 = item => {
    return (
      <TouchableOpacity
        ...
        style={[styles.listView, { backgroundColor: Colors().darkShadow2 }]}>
        <View
          style={[
            styles.listView,
            { backgroundColor: Colors().inputLightShadow },
  ...
  const onIncreDecre = ({ returnValue, formik, keyToSet }) => {
    ...
    if (type == 'approve') {
      multipliedPrice(
        ...
        formik.values.request_stock_by_user[index]?.new_request_stock[idx]
          ?.approved_rate, // itm.current_item_price, //fixed value
        `request_stock_by_user.${index}.new_request_stock.${idx}.approve_fund_amount`,
        formik.setFieldValue,
      );
    } else {
      multipliedPrice(
        returnValue, //change value
        formik.values.request_stock_by_user[index]?.new_request_stock[idx]
          ?.rate, // itm.current_item_price, //fixed value
        `request_stock_by_user.${index}.new_request_stock.${idx}.fund_amount`,
        formik.setFieldValue,
      );
    }
  };
  ...
  return (
    <View style={{}}>
          ...
          {type != 'approve' && (
            <View style={styles.crossIcon}>
              <Icon
                ...
                onPress={() =>
                  formik.setFieldValue(
                    `request_stock_by_user.${index}.new_request_stock`,
                    formik.values.request_stock_by_user[
                      index
                    ].new_request_stock.filter((_, i) => i !== idx),
                  )
                }
              />
            </View>
                            ...
                            <>
                              <View style={styles.createSkillView}>
                                ...
                                <Icon
                                  ...
                                  onPress={() => {
                                    formik.setFieldValue(
                                      `request_stock_by_user.${index}.new_request_stock.${idx}.title`,
                                      {
                                        label: newItem,
                                        value: newItem,
                                        __isNew__: true,
                    ...
                    <View
                      ...
                      <TextInput
                        ...
                        onChangeText={formik.handleChange(
                          `request_stock_by_user.${index}.new_request_stock.${idx}.description`,
                        )}
                      />
                    </View>
                  ),
                    ...
                    <View
                      ...
                      <View style={{ flexDirection: 'row' }}>
                        ...
                        <TextInput
                          ...
                          onChangeText={txt => {
                            formik.setFieldValue(
                              `request_stock_by_user.${index}.new_request_stock.${idx}.rate`,
                              txt,
                            ),
                              multipliedPrice(
                                txt,
                      ...
                      {!itm.rate && type != 'approve' && (
                        <View style={{}}>
                          <Icon
                            ...
                            color={Colors().red}
                          />
                          {/* {formik.touched.request_stock_by_user &&
                                formik.touched.request_stock_by_user[index] &&
                                formik.errors.request_stock_by_user &&
                    ...
                    <View
                      ...
                      <View style={{ flex: 1 }}>
                        <Dropdown
                          ...
                          onChange={val => {
                            formik.setFieldValue(
                              `request_stock_by_user.${index}.new_request_stock.${idx}.unit_id`,
                              val,
                            );
                          }}
                        />
                        ...
                        component: (
                          <View
                            ...
                            <TextInput
                              ...
                              onChangeText={txt => {
                                formik.setFieldValue(
                                  `request_stock_by_user.${index}.new_request_stock.${idx}.approved_rate`,
                    ...
                    <>
                      <View
                        ...
                        <IncreDecreComponent
                          ...
                          keyToSet={
                            type == 'approve'
                              ? `request_stock_by_user.${index}.new_request_stock.${idx}.approved_qty`
                              : `request_stock_by_user.${index}.new_request_stock.${idx}.qty`
                          }
      ...
      {formik.values.request_stock_by_user[index].new_request_stock.length >
        0 &&
        type != 'approve' && (
          <View style={{ flexDirection: 'row', marginLeft: 30 }}>
            <Text style={[styles.title, { color: Colors().purple }]}>
              TOTAL new Request price ₹{' '}
              {getTotal(
                formik.values.request_stock_by_user[index].new_request_stock,
                'fund_amount',
              )}
            </Text>
          </View>
