...
const StockRequestApprovedDataScreen = ({navigation, route}) => {
  ...
  const getFinal = (data, key) => {
    ...
    if (data?.request_stock) {
      data?.request_stock.forEach(itm => {
        totalOfOldItem += parseFloat(itm[key] || itm['approve_quantity']) || 0;
      });
    }
    if (data?.new_request_stock) {
      data?.new_request_stock.forEach(itm => {
        totalOfNewItem += parseFloat(itm[key]) || 0;
      });
    }
  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: Colors().screenBackground}}>
      <CustomeHeader headerTitle={label.APPROVED_STOCK_DATA} />
          ...
          {data?.approved_data ? (
            <ScrollView
              ...
              <View style={styles.mainView}>
                ...
                {/*APPROVED items card */}
                {data?.approved_data[0]?.request_stock && (
                  <NeumorphCard>
                    <View style={styles.cardContainer}>
                      <Text
                      ...
                      <ScrollView
                        ...
                        <DataTable>
                          ...
                          <ScrollView>
                            {data?.approved_data[0]?.request_stock.map(
                              (itm, index) => (
                                <>
                ...
                {/*New Approved items card  */}
                {data?.approved_data[0]?.new_request_stock &&
                  !isObjectEmpty(data?.approved_data[0]?.new_request_stock) && (
                    <NeumorphCard>
                      <View style={styles.cardContainer}>
                        <Text
                          style={[styles.headingTxt, {color: Colors().purple}]}>
                        ...
                        <ScrollView
                          ...
                          <DataTable>
                            ...
                            <ScrollView>
                              {data?.approved_data[0]?.new_request_stock.map(
                                (itm, index) => (
                                  <>
                                    <DataTable.Row key={index} style={{}}>
                                      <DataTable.Cell
...
export default StockRequestApprovedDataScreen;
