...
const SubModuleScreen = ({ navigation, route }) => {
  ...
  const navigationFunctionWithPath = path => {
    const navigationMap = {
      ...
      '/create-work-quotations': {
        screen: 'AddUpdateWorkQuotationScreen',
      ...
      '/Tutorials': { screen: 'TutorialTopTab' },
