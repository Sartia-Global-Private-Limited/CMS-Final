...
const ExpensePunchDetailScreen = ({navigation, route}) => {
  ...
  const hideMenu2 = val => {
    setVisible2(false);
    if (val !== undefined) {
      navigation.navigate('ExpensePunchItemHistory', {
  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: Colors().screenBackground}}>
      <CustomeHeader
        headerTitle={`${label.EXPENSE_PUNCH} ${label.DETAIL}`}
...
export default ExpensePunchDetailScreen;
