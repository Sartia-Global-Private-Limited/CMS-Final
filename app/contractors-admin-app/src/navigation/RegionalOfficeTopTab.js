...
import RegionalOfficeListScreen from '../screens/regional office/RegionalOfficeListScreen';
const Tab = createMaterialTopTabNavigator();

const RegionalOfficeTopTab = ({ navigation }) => {
  const label = ScreensLabel();
  return (
    <>
      <View style={{ marginBottom: 1 }}>
        <CustomeHeader headerTitle={label.REGIONAL_OFFICE} />
      </View>
      <Tab.Navigator
        // initialRouteName={{RegionalOfficeListScreen}}
        sceneContainerStyle={{
        ...
        <Tab.Screen
          name="RegionalOfficeListScreen1"
        ...
        />
        <Tab.Screen
          name="RegionalOfficeListScreen2"
          component={RegionalOfficeListScreen}
        ...
        <Tab.Screen
          name="RegionalOfficeListScreen3"
          component={RegionalOfficeListScreen}
...
export default RegionalOfficeTopTab;
